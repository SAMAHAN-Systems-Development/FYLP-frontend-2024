    ...
    <div id='main' className='w-full flex flex-col px-[50px] md:px-[100px] items-center'>
      ...
      <div id='content' className='flex flex-col lg:flex-row mt-[52px] w-full ml-auto mr-auto items-center lg:items-start lg:justify-between'>
        <div id='left' className='  flex flex-col lg:flex-row'>
          ...
          <div id='links' className='font-poppins w-[200px] h-[180px] ml-0 xl:ml-20 flex flex-col space-y-3 text-center lg:text-left mb-[25px] lg:mb-0'>
            <p className=' font-bold text-[15px] w-[200px] h-[30px]'>Quick Links</p>
            <Link href="#" className=' text-sm hover:text-[#FD1E0A] transition-colors duration-300'>Home</Link>
            <Link href="#" className='text-sm hover:text-[#FD1E0A] transition-colors duration-300'>About Us</Link>
            <Link href="#" className='text-sm hover:text-[#FD1E0A] transition-colors duration-300'>FAQ</Link>
            <Link href="#" className='text-sm hover:text-[#FD1E0A] transition-colors duration-300'>Check Status</Link>
            <Link href="#" className='text-sm hover:text-[#FD1E0A] transition-colors duration-300'>Meet The Developers</Link>
          </div>
          <div id='address' className='font-poppins w-[200px] h-[169px] ml-0 lg:ml-20 flex flex-col space-y-2 text-center lg:text-left my-[25px] lg:my-0'>
            <p className=' font-bold text-[15px] '>Address</p>
            <p className=' h-[139px] w-[200px] text-sm font-normal leading-[21px] '>6/F Community Center of the First Companions, Ateneo de Davao University, Roxas Ave, Poblacion District, Davao City, 8000 Davao del Sur</p>
          </div>
        </div>
        <div id='right' className='h-[198px] w-[200px] font-poppins'>
          <div id='email' className='flex flex-col space-y-2 text-center lg:text-right my-[25px] lg:my-0'>
            <p className=' font-[600] text-center lg:text-right text-[15px]'>E-mail</p>
            <p className=' w-full text-sm font-normal text-center leading-5 lg:text-right'>contact@fylp.com</p>
            <div className='mt-6'></div>
            <p className=' font-[600]  text-[15px] text-center lg:text-right'>Telephone</p>
            <p className=' w-full text-sm font-normal leading-5 text-center lg:text-right'>+63 970 376 3758</p>
            <div className='mt-6'></div>
