...
function EligibilityCardLight({ icon, title, details }) {
  return (
    <div className="xl:w-[18.75rem] xl:items-center xl:justify-center xsm:w-full border-blue xl:border-4 xsm:border-[2.333px] rounded-[0.9375rem] transition-transform duration-300 ease-in-out hover:scale-110 flex flex-col xl:flex-col xsm:flex-row xsm:items-start gap-2 py-6 px-5">
