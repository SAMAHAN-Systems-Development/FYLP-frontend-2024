  ...
  return (
    ...
    >
      ...
      <div className='flex flex-col lg:items-center lg:justify-center items-center sm:items-start text-center sm:text-left'>
        <div className='text-xl text-white font-medium font-poppins'>{title}</div>
        <div className='text-base text-white lg:text-center font-extralight font-poppins'>{details}</div>
      </div>
    </div>
  );
}
