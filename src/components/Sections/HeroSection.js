    ...
    return (
        <div className='w-full sm:h-[750px] xsm:h-[500px] mt-[205px] relative'>
            <div id='left-group' className='2xl:w-[36.1875rem] h-[25.9375rem] relative mx-[9.5rem] lg:mx-[10.5rem] md:mx-[94px] sm:mx-[53px] xsm:mx-[35.33px] z-30 flex flex-col items-center xl:items-start'>
                <div className='flex justify-center xl:justify-start w-full transition-all'>
                    <Image 
                        src={FYLPLogo} 
                        alt='FYLP Logo' 
                        className='md:w-[522px] md:h-[188px] sm:w-[430.37px] sm:h-[155px] xsm:w-[286.91px] xsm:h-[103.33px] xl:left-[60px] transition-all duration-300' 
                    />
                </div>
                <div className="md:w-[579px] xsm:w-[310px] sm:w-[450px] h-20 flex justify-center xl:justify-start xl:left-0 xsm:top-[115px] md:top-[200px] sm:top-[170px] absolute xl:text-left xsm:text-center text-black sm:text-[25px] xsm:text-[16.67px] font-semibold font-poppins">
                    Join us on this unparalleled adventure where leadership meets community
                </div>
                <div id='Button' className='flex justify-center xl:justify-start absolute sm:top-[330px] xsm:top-[210px]'>
