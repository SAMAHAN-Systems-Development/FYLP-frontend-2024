...
const CheckStatusTxtField = () => {
  return (
    <div className="flex justify-center items-center min-h-screen px-4">
      <div className="relative flex items-center max-w-[699px] max-h-[54px]  rounded-full bg-gray-200 w-[350px] h-[47px] md:w-[550px] md:h-[54px] lg:w-[650px] lg:h-[54px] xl:w-[699px] xl:h-[54px]">
