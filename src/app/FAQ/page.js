        ...
        <div>
            ...
            <Divider title={'Frequently Asked Questions'}>
                <div className="flex justify-center flex-wrap">
                    ...
                    <div id="right-group" className="flex-shrink-0 sm:w-[18.75rem] sm:h-[18.75rem] w-[14.75rem] h-[14.75rem] xsm:mt-6 lg:mt-6 2xl:mt-0  border-[#9CA3AF] border-4 rounded-[0.9375rem] flex flex-col justify-center items-center p-4">
